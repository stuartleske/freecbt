...
An experimental web-based version of FreeCBT. Very beta. Use with caution.
...
* Github continuous integration:
  * master branch pushes: build, test, and deploy to Netlify
  * pull requests: build, test, and preview on Netlify
